    ...
    const fetchArticles = async () => {
      try {
        ...
        if (query) {
          ...
          data = await articleService.getArticlesByCategory(categoryId);
        } else {
        ...
        {isLoading ? (
          ...
          <div className="bg-gray-800 border border-gray-700 text-gray-300 px-4 py-8 rounded-lg text-center">
            ...
            <p className="text-gray-400 mb-4">
              {query ? `No articles match your search "${query}".` : categoryId ? 'No articles in this category yet.' : 'No articles have been published yet.'}
            </p>
